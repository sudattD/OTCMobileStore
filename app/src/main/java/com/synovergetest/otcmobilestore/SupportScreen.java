...
public class SupportScreen extends OTCBaseActivity {
    ...
    private void settingUpActionBarView() {
        ...
        View mView = infalInflater.inflate(R.layout.app_bar_support, null);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_support_screen, menu);
        return true;
    }
